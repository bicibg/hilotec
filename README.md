...
> **Branch: `design-v2`** — Alpine Precision light/dark hybrid theme with scroll animations. Security hardening has not been applied to this branch yet. See [docs/10-BRANCH-COMPARISON.md](docs/10-BRANCH-COMPARISON.md) for details and merge instructions.
